...
document.addEventListener('click',e=>{const r=e.target.closest('[data-revoke]');if(r)revoke(r.dataset.revoke);const c=e.target.closest('[data-revoke-code]');if(c)revokeCode(c.dataset.revokeCode);const p=e.target.closest('[data-confirm-payment]');if(p)confirmPayment(p.dataset.confirmPayment);});
