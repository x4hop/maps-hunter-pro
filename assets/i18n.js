...
function installChangaTheme(){
  if(!document.getElementById('mhp-changa-font')){
    const link=document.createElement('link');link.id='mhp-changa-font';link.rel='stylesheet';link.href='https://fonts.googleapis.com/css2?family=Changa:wght@400;500;600;700;800&display=swap';document.head.appendChild(link);
  }
  ...
  if(!document.getElementById('mhp-language-font-fixes')){
    const style=document.createElement('style');style.id='mhp-language-font-fixes';style.textContent=`
      ...
      @media(max-width:760px){body{font-size:16.5px}.hero h1{line-height:1.12!important}.section-title h2{line-height:1.2!important}.card h3,.price-card h3{line-height:1.3!important}.lang-globe{min-width:54px!important;min-height:42px!important;padding:0 10px!important}}
