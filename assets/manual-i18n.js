...
const U={
  en:{
    ...
    how_1:'1. Choose a plan',how_1_desc:'Choose Monthly or Lifetime.',
    ...
    selected_plan:'Selected plan: choose Monthly or Lifetime',
    ...
    unlimited_annual:'Lifetime access without a daily platform limit',unlimited_annual_desc:'One-time access for agencies and higher daily volumes.',
    monthly_limit:'Up to 1,500 per day',monthly_limit_desc:'The monthly plan includes up to 1,500 leads per day.',
    pricing_title:'Pricing',pricing_desc:'Choose monthly access or get lifetime access with a one-time payment.',
    ...
    best_value:'Best value',annual_plan:'Lifetime',per_year:'one-time',save_140:'One-time payment · lifetime access',unlimited_daily:'No commercial daily platform limit',everything_monthly:'Everything in Monthly',ideal_agencies:'Built for agencies and teams',priority_updates:'Priority product updates',choose_annual:'Choose Lifetime',
    faq_title:'FAQ',faq1_q:'Monthly or Lifetime?',faq1_a:'Monthly: $20 with up to 1,500 leads/day. Lifetime: $100 one-time with no commercial daily platform limit.',faq2_q:'International phone numbers?',faq2_a:'Yes. Numbers can be formatted for the search country.',faq3_q:'How do I get the activation code?',faq3_a:'Send your payment proof on WhatsApp. After verification, the activation code is sent to you.'
  },
  ar:{
    nav_how:'كيف تعمل',
    ...
    how_1:'1. اختر الباقة',how_1_desc:'اختر الشهري أو مدى الحياة.',
    ...
    selected_plan:'الباقة المختارة: اختر الشهري أو مدى الحياة',
    ...
    unlimited_annual:'وصول مدى الحياة بدون حد يومي للمنصة',unlimited_annual_desc:'شراء لمرة واحدة مناسب للوكالات وحجم العمل اليومي الأكبر.',
    monthly_limit:'حتى 1,500 يوميًا',monthly_limit_desc:'الباقة الشهرية تشمل حتى 1,500 نتيجة يوميًا.',
    pricing_title:'الأسعار',pricing_desc:'اختر الشهري أو احصل على وصول مدى الحياة بدفعة واحدة.',
    ...
    best_value:'الأوفر',annual_plan:'مدى الحياة',per_year:'دفعة واحدة',save_140:'دفعة واحدة · وصول مدى الحياة',unlimited_daily:'لا يوجد حد يومي تجاري للمنصة',everything_monthly:'كل مزايا الشهري',ideal_agencies:'مناسب للوكالات والفرق',priority_updates:'أولوية في التحديثات',choose_annual:'اختر مدى الحياة',
    faq_title:'FAQ',faq1_q:'شهري أم مدى الحياة؟',faq1_a:'الشهري: 20$ وحتى 1,500 نتيجة يوميًا. مدى الحياة: 100$ دفعة واحدة بدون حد يومي تجاري للمنصة.',faq2_q:'هل الأرقام بصيغة دولية؟',faq2_a:'نعم، تُنسّق الأرقام حسب دولة البحث.',faq3_q:'كيف أستلم كود التفعيل؟',faq3_a:'أرسل إثبات الدفع عبر واتساب. بعد التحقق يصلك كود التفعيل.'
  },
  ru:{
    ...
    how_1:'1. Выберите тариф',how_1_desc:'Месячный или пожизненный.',
    ...
    selected_plan:'Выбранный тариф: месячный или пожизненный',
    ...
    unlimited_annual:'Пожизненный доступ без дневного лимита платформы',unlimited_annual_desc:'Единоразовая покупка для агентств и больших ежедневных объёмов.',
    monthly_limit:'До 1 500 в день',monthly_limit_desc:'Месячный тариф включает до 1 500 лидов в день.',
    pricing_title:'Тарифы',pricing_desc:'Выберите месячный тариф или пожизненный доступ с единоразовой оплатой.',
    ...
    best_value:'Выгоднее',annual_plan:'Навсегда',per_year:'один раз',save_140:'Один платёж · пожизненный доступ',unlimited_daily:'Без коммерческого дневного лимита платформы',everything_monthly:'Всё из месячного тарифа',ideal_agencies:'Для агентств и команд',priority_updates:'Приоритетные обновления',choose_annual:'Выбрать навсегда',
    faq_title:'FAQ',faq1_q:'Месяц или навсегда?',faq1_a:'Месяц: $20 и до 1 500 лидов в день. Пожизненный доступ: $100 единоразово без коммерческого дневного лимита платформы.',faq2_q:'Международный формат номеров?',faq2_a:'Да. Номера форматируются по стране поиска.',faq3_q:'Как получить код активации?',faq3_a:'Отправьте подтверждение оплаты в WhatsApp. После проверки вы получите код.'
  },
  de:{
    ...
    how_1:'1. Tarif wählen',how_1_desc:'Monatlich oder Lifetime.',
    ...
    selected_plan:'Gewählter Tarif: monatlich oder Lifetime',
    ...
    unlimited_annual:'Lebenslanger Zugang ohne tägliches Plattformlimit',unlimited_annual_desc:'Einmaliger Kauf für Agenturen und höhere tägliche Volumen.',
    monthly_limit:'Bis zu 1.500 pro Tag',monthly_limit_desc:'Der Monatsplan enthält bis zu 1.500 Leads pro Tag.',
    pricing_title:'Preise',pricing_desc:'Monatlichen Zugang wählen oder Lifetime-Zugang einmalig bezahlen.',
    ...
    best_value:'Bestes Angebot',annual_plan:'Lifetime',per_year:'einmalig',save_140:'Einmal zahlen · lebenslanger Zugang',unlimited_daily:'Kein kommerzielles tägliches Plattformlimit',everything_monthly:'Alles aus Monatlich',ideal_agencies:'Für Agenturen und Teams',priority_updates:'Priorisierte Updates',choose_annual:'Lifetime wählen',
    faq_title:'FAQ',faq1_q:'Monatlich oder Lifetime?',faq1_a:'Monatlich: $20 und bis zu 1.500 Leads pro Tag. Lifetime: einmalig $100 ohne kommerzielles tägliches Plattformlimit.',faq2_q:'Internationale Telefonnummern?',faq2_a:'Ja. Nummern werden passend zum Suchland formatiert.',faq3_q:'Wie erhalte ich den Aktivierungscode?',faq3_a:'Sende den Zahlungsnachweis per WhatsApp. Nach der Prüfung erhältst du den Code.'
  },
  es:{
    ...
    how_1:'1. Elige un plan',how_1_desc:'Mensual o de por vida.',
    ...
    selected_plan:'Plan elegido: mensual o de por vida',
    ...
    unlimited_annual:'Acceso de por vida sin límite diario de plataforma',unlimited_annual_desc:'Compra única para agencias y mayores volúmenes diarios.',
    monthly_limit:'Hasta 1.500 al día',monthly_limit_desc:'El plan mensual incluye hasta 1.500 leads al día.',
    pricing_title:'Precios',pricing_desc:'Elige acceso mensual o acceso de por vida con un único pago.',
    ...
    best_value:'Mejor opción',annual_plan:'De por vida',per_year:'pago único',save_140:'Un solo pago · acceso de por vida',unlimited_daily:'Sin límite diario comercial de plataforma',everything_monthly:'Todo lo del plan mensual',ideal_agencies:'Para agencias y equipos',priority_updates:'Actualizaciones prioritarias',choose_annual:'Elegir de por vida',
    faq_title:'FAQ',faq1_q:'¿Mensual o de por vida?',faq1_a:'Mensual: $20 y hasta 1.500 leads al día. De por vida: $100 como pago único sin límite diario comercial de plataforma.',faq2_q:'¿Teléfonos en formato internacional?',faq2_a:'Sí. Los números se formatean según el país de búsqueda.',faq3_q:'¿Cómo recibo el código de activación?',faq3_a:'Envía el comprobante por WhatsApp. Tras verificar el pago, recibirás el código.'
  }
};
