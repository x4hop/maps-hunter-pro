...
Updated: 2026-09-16. This inventory must match the Chrome Web Store privacy form and published policy.
...
| Public email/social links | Google Maps result/detail pages when present | Local extension storage | Direct contact-field extraction without opening the business website | Same as results |
...
No remote JavaScript or WASM is executed. XLSX/CSV/JSON generation is bundled locally. No browsing history, cookies or visited-site passwords are read. The extension does not crawl business websites for email or social enrichment.

## Permission justifications
- `storage`: local results, settings, license and resumable work.
- `scripting`: packaged collector/extractor in user-selected Google Maps tabs.
...
- Google Maps origins: core operation; Anas API origin: licensing and limits.
